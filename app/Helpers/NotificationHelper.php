...
class NotificationHelper
{
    ...
    public static function sendTransactionSMS(Transaction $transaction)
    {
        ...
        // Message format
        $message = "সম্মানিত {$donorName}, মসজিদ ফান্ডে- {$monthName} {$year} - মাসের ৳{$amount}TK দান সফলভাবে রেকর্ড হয়েছে। জাযাকাল্লাহু খাইরান। - মসজিদ ই কোবা";
        // Send SMS
    ...
    public static function sendDonationSMS(Donation $donation)
    {
        ...
        $message = "সম্মানিত {$donorName}, মসজিদ ফান্ডে {$date} তারিখে ৳{$amount} টাকার দানের জন্য ধন্যবাদ। আপনার সমর্থন অত্যন্ত প্রশংসনীয়। জাযাকাল্লাহু খাইরান। মসজিদ ই কোবা";
